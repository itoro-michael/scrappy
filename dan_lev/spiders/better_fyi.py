...
from dan_lev.items import TrackerItem
...
class BetterFyiSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for tracker in response.xpath("//ul[@data-set-text='html list']/li/a"):
            ...
            tracker_item["found_url"] = tracker_found_url
            tracker_item["title"] = tracker_title
            tracker_item["website"] = tracker_website
            
            request = scrapy.Request(tracker_found_url,
                             callback=self.parse_tracker,
                             cb_kwargs=dict(tracker_item=tracker_item))
    ...
    def parse_tracker(self, response, tracker_item):
        ...
        # set parsing rule for tracker_description_source field
        ...
        # set parsing rule for tracker_block_rule field
        if int(bool_val):
        ...
        tracker_item['description'] = tracker_description
        tracker_item['description_source'] = tracker_description_source
        tracker_item['block_rule'] = tracker_block_rule
